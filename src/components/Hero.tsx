...
export default function Hero() {
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse 70% 60% at 10% 65%, rgba(184,150,62,.1) 0%, transparent 65%), radial-gradient(ellipse 50% 50% at 88% 18%, rgba(184,150,62,.07) 0%, transparent 55%), var(--color-bg)",
        padding: "0 40px",
      }}
    >
      <div
      ...
      >
        ...
        >
          ...
          <h1
            ...
            style={{ fontSize: "clamp(52px, 6vw, 86px)", marginBottom: 24 }}
          >
            Pele saudável,<br />
            <em>confiança</em><br />
            de volta.
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center", flexWrap: "wrap" as const, marginBottom: 40 }}>
            <Link
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 8px 24px rgba(12,12,11,.2)";
        ...
        >
          ...
          >
            ...
            <div
              style={{
                position: "absolute",
                inset: 0,
                background: "radial-gradient(ellipse at 40% 25%, rgba(184,150,62,.12) 0%, transparent 60%)",
                pointerEvents: "none",
              }}
            />
          </div>
          ...
          >
            ...
            <div
              ...
              style={{ fontSize: 30, fontWeight: 400, color: "var(--color-text-main)", letterSpacing: "-0.03em", lineHeight: 1, marginBottom: 2 }}
            >
              4.9
            </div>
