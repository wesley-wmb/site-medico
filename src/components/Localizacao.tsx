...
const details = [
  { icon: MapPin, label: "Endereço", value: "São José dos Pinhais, PR" },
  { icon: Phone, label: "Telefone / WhatsApp", value: "(41) 9 9107-8805", href: `https://wa.me/${WA}` },
      ...
      <div style={{ maxWidth: 1160, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.8fr", gap: 64, alignItems: "center" }} className="map-grid">
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          ...
          <h2 className="font-display" style={{ fontSize: "clamp(26px, 2.8vw, 38px)", fontWeight: 400, letterSpacing: "-0.025em", lineHeight: 1.15, color: "var(--color-text-main)", marginBottom: 32 }}>
            Venha nos <em style={{ fontStyle: "italic", color: "var(--color-gold)" }}>conhecer</em><br />em São José dos Pinhais
          </h2>
              ...
              return (
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 14 }}>
                  ...
                  <div>
                    ...
                    {d.href
                      ? <a href={d.href} target="_blank" rel="noopener noreferrer" style={{ fontSize: 14, color: "var(--color-text-main)", lineHeight: 1.55, textDecoration: "none" }}>{d.value}</a>
        ...
        >
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3601.5!2d-49.3470377!3d-25.4410155!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94dce3953fa4876d%3A0x3538376266d8b0ee!2sInfinity%20Est%C3%A9tica%20e%20Tricologia%20Avan%C3%A7ada!5e0!3m2!1spt-BR!2sbr!4v1718000000000!5m2!1spt-BR!2sbr"
