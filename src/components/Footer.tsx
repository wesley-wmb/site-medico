      ...
      <div style={{ maxWidth: 1160, margin: "0 auto", padding: "0 40px", display: "grid", gridTemplateColumns: "1.8fr 1fr 1fr", gap: 64, paddingBottom: 64 }} className="footer-inner">
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
            <img src="https://ugc.production.linktr.ee/07f41350-18da-4850-9fc4-df3a7db7afeb_Infinity-LOGO.png" alt="Logo Infinity" style={{ width: 32, height: 32, objectFit: "contain" }} />
          ...
          <a href="https://www.instagram.com/infinity.esteticaavancada/" target="_blank" rel="noopener noreferrer"
            style={{ display: "inline-flex", alignItems: "center", gap: 6, marginTop: 12, fontSize: 12, color: "rgba(255,255,255,.3)", textDecoration: "none", transition: "color .2s" }}
            onMouseEnter={(e) => (e.currentTarget.style.color = "rgba(255,255,255,.6)")} onMouseLeave={(e) => (e.currentTarget.style.color = "rgba(255,255,255,.3)")}
          >
          ...
          <div style={{ display: "flex", flexDirection: "column" as const, gap: 10 }}>
            {procs.map((p) => (
              <Link key={p} href="#agendar" style={{ fontSize: 13, color: "rgba(255,255,255,.32)", textDecoration: "none", transition: "color .2s" }}
                onMouseEnter={(e) => (e.currentTarget.style.color = "rgba(255,255,255,.65)")} onMouseLeave={(e) => (e.currentTarget.style.color = "rgba(255,255,255,.32)")}>{p}</Link>
            ))}
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column" as const, gap: 10 }}>
            <a href={`https://wa.me/${WA}`} target="_blank" rel="noopener noreferrer" style={{ fontSize: 13, color: "rgba(255,255,255,.32)", textDecoration: "none", transition: "color .2s" }}
              onMouseEnter={(e) => (e.currentTarget.style.color = "rgba(255,255,255,.65)")} onMouseLeave={(e) => (e.currentTarget.style.color = "rgba(255,255,255,.32)")}>
              WhatsApp: (41) 9 9107-8805
            </a>
